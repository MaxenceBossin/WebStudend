...
// Returns the private 'App\Repository\BaguetteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BaguetteRepository.php';

return $this->privates['App\Repository\BaguetteRepository'] = new \App\Repository\BaguetteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
