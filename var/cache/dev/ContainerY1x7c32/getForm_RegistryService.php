...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\EtudiantType' => function () {
    return ($this->privates['App\Form\EtudiantType'] ?? $this->privates['App\Form\EtudiantType'] = new \App\Form\EtudiantType());
