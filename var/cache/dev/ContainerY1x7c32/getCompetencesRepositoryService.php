...
// Returns the private 'App\Repository\CompetencesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CompetencesRepository.php';

return $this->privates['App\Repository\CompetencesRepository'] = new \App\Repository\CompetencesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
