...
// Returns the private 'App\Repository\EtudiantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EtudiantRepository.php';

return $this->privates['App\Repository\EtudiantRepository'] = new \App\Repository\EtudiantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
